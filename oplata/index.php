  ...
  <div class="content" style="">	
	<div class="row clearfix" style="max-width:90%; margin-left:auto; margin-right:auto;">
        ...
        <div class="column col_80">
          <h2 style="margin: 0;"><strong>Оплата предложения-пакета Коуч-Сессия "Охотник на демонов"+"Мультипликатор 10х"</strong></h2> 
...
<input type="text" placeholder="Введи здесь свой Email" id="my_email" name="email"  value="<?php echo $email; ?>" /> </div>
...
<!-- <form name="payment" action="https://rbkmoney.ru/acceptpurchase.aspx" method="post"  onClick="return validate_form ( );">
 ...
 <form id="form10" name="payment" action="https://www.interkassa.com/lib/payment.php" method="post" enctype="application/x-www-form-urlencoded" accept-charset="cp1251" onclick="return validate_form ( );">
...
<div class="email-input">
<input type="hidden" placeholder="Введи здесь свой Email" id="my_email" name="my_email"  value="<?php echo $email; ?>" />
<span id="validEmail" class="error" style="margin-left: 3px;"></span></div>


<input name="imageField" type="submit" class="myButton center" value="Другие способы оплаты">
</form>
	...
	<table width="80%" border="0" class="center">
      <tr>
        ...
        <h2 style="margin: 0;">$ <?php echo $price; ?></h2></td>
            ...
            <p style="color:#797878;" >Ты всегда можешь  написать на почту <a href="mailto:support@goldcoach.ru" id="support_email"></a> или <br>
              позвонить по следующим телефонам:<br>
Россия: <strong>+7 495 133 82 24</strong><br>
Украина: <strong>+38 096 916 13 88</strong></p>
            <p style="color:#797878;">01015, Украина, г. Киев, ул. Старонаводницкая 6-Б, офис 210. <br> Официальный адрес компании GoldCoach Suite 1,4 Queen Street, Edinburgh, Scotland, EH21JE, United Kingdom </p>
...
<!-- cloud flare plugin "email protected" solving   -->

<script>
  $(document).ready(function() {
    $('#support_email').text('support@goldcoach.ru');
  });
</script>
